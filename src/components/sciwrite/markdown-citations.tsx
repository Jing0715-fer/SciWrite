        ...
        >
          {refs.length > 0 ? (
            ...
            <div className="space-y-1">
              <p className="font-semibold text-[11px] text-red-600 dark:text-red-400">
                Unresolved citation [{inner}]
              </p>
              <p className="text-[10px] text-muted-foreground">
                No matching reference record found. This citation may be
                hallucinated or out of range — it will be flagged by the
                adversarial citation audit.
              </p>
            </div>
          )}
